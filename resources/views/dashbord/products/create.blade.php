                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input required placeholder="English Product Name" id="name_en"
                                            value="{{ old('name_en') }}" name="name_en" type="text"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input required placeholder="{{ __('Price') }}" id="price"
                                            value="{{ old('price') }}" name="price" type="text" class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        <label for="quantity">{{ 'quantity' }} </label>
                                        <input required placeholder="{{ 'quantity' }}" id="quantity"
                                            value="{{ old('quantity') }}" name="quantity" type="number"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input required placeholder="{{ __('Arabic Product Name') }}" id="name_ar"
                                            value="{{ old('name_ar') }}" name="name_ar" type="text"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <textarea placeholder="{{ __('Arabic Product Description') }}" name="description_ar" class="form-control"
                                            id="productdesc" rows="4">{{ old('description_ar') }}</textarea>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input required id="coupon_per_unit" placeholder="{{ __('Coupon Per Unit') }}"
                                            value="{{ old('coupon_per_unit') }}" name="coupon_per_unit" type="number"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input required placeholder="{{ __('English Award Name') }}" id="award_name_en"
                                            value="{{ old('award_name_en') }}" name="award_name_en" type="text"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <textarea placeholder="{{ __('English Award Description') }}" name="award_description_en" class="form-control"
                                            ...
                                            rows="5">{{ old('award_description_en') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        ...
                                        <input required placeholder="{{ __('Arabic Award Name') }}" id="award_name_ar"
                                            value="{{ old('award_name_ar') }}" name="award_name_ar" type="text"
                                            class="form-control">
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <textarea placeholder="{{ __('English Award Description') }}" name="award_description_ar" class="form-control"
                                            ...
                                            rows="5">{{ old('award_description_ar') }}</textarea>
                                    </div>
                                </div>
                            </div>
